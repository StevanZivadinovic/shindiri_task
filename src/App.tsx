  ...
  return (
    ...
    <div>
      ...
      <nav className="p-4 flex justify-end">
        ...
        <Link to="#" className="mr-4" onClick={()=>{handleLogout()}}>
          Logout
        </Link>
...
*/}
      <Routes>
      <Route path="/" element={authenticated ? <Navigate to="/characters" /> : <Login />} />
          <Route path="/signup" element={authenticated ? <Navigate to="/characters" /> : <SignUp />} />
          
          {/* Protected route */}
          <Route path="/characters" element={authenticated ? <Characters /> : <Navigate to="/" />} />
